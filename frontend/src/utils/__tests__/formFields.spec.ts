...
import { createAddressInput, createContactInput, normalizeAddressInput, normalizeContactInput } from '../formFields';
...
describe('form fields', () => {
  ...
  it('normaliza telefone e CEP para o contrato da API', () => {
    expect(normalizeContactInput({ codigo_pais: '+55', ddd: '(11)', numero: '99999-1234' })).toEqual({
      codigo_pais: '+55',
      ddd: '11',
      numero: '999991234'
    });
