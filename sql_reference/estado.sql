...
COMMENT ON TABLE estados IS 'Unidades Federativas';
...
ALTER SEQUENCE estado_id_seq OWNED BY estados.id;
...
ALTER TABLE ONLY estados ALTER COLUMN id SET DEFAULT nextval('estado_id_seq'::regclass);

--
-- Data for Name: estados; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY estados (id, nome, uf, ibge, pais, ddd) FROM stdin;
1	Acre	AC	12	1	[68]
