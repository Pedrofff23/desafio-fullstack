...
COMMENT ON TABLE paises IS 'Países e Nações';


--
-- Name: COLUMN paises.sigla; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN paises.sigla IS 'ISO 3166-1 Alpha2';
...
ALTER SEQUENCE pais_id_seq OWNED BY paises.id;

--
-- Name: paises id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY paises ALTER COLUMN id SET DEFAULT nextval('pais_id_seq'::regclass);

--
-- Data for Name: paises; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY paises (id, nome, nome_pt, sigla, bacen, ddi) FROM stdin;
...
--
-- Name: paises pais_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
